  ...
  private async rescueProductIdentification(
    ...
    const rescue = await this.requestVisionJson(
      ...
      [
        ...
        '- If visible brand or box text includes Ponti, Paniagua or Sevilla on apple cartons, return manzana.',
        '- If the top layer shows many medium round red/yellow apples in shallow produce trays, prefer manzana over melon.',
  ...
  private async rescueLabelOcrProduct(
    ...
    const rescue = await this.requestVisionJson(
      ...
      [
        ...
        '- If you can read Ponti, Paniagua or Sevilla on apple-style cartons, producto must be manzana.',
  ...
  private async rescueVisualProductGuess(
    ...
    const rescue = await this.requestVisionJson(
      ...
      [
        ...
        '',
        'Rules:',
        '- If the visible top layer shows many medium round red/yellow apples packed in shallow cartons, prefer "manzana".',
        '- If carton branding looks like Ponti, Paniagua or Sevilla and the fruit is red/yellow and apple-shaped, prefer "manzana".',
